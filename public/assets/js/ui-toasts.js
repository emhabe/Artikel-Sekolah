"use strict";
!(function () {
    const t = document.querySelector(".toast-ex"),
        e = document.querySelector(".toast-placement-ex"),
        o = document.querySelector("#showToastAnimation"),
    ...
    function c(o) {
        o &&
            ...
            (e &&
                ...
                DOMTokenList.prototype.remove.apply(e.classList, i)),
            t && t.classList.remove(a, n),
            o.dispose());
    }
    o &&
        (o.onclick = function () {
            ...
            (s.onclick = function () {
                l && c(l),
                    ...
                    (i = document
                        ...
                        .value.split(" ")),
                    e.classList.add(a),
                    DOMTokenList.prototype.add.apply(e.classList, i),
                    (l = new bootstrap.Toast(e)),
                    l.show();
            });
})(),
    $(function () {
        ...
        $("#closeButton").click(function () {
            ...
            $("#showtoast").click(function () {
                var s,
                    a,
                    n = $("#toastTypeGroup input:radio:checked").val(),
                    i = "rtl" === $("html").attr("dir"),
                    r = $("#message").val(),
                    l = $("#title").val() || "",
                    c = $("#showDuration"),
                ...
                (s =
                    ...
                    s != toastr.options.positionClass &&
                    ...
                    c.val().length &&
                        (toastr.options.showDuration = parseInt(c.val())),
                    p.val().length &&
                        (toastr.options.hideDuration = parseInt(p.val())),
                    u.val().length &&
                        (toastr.options.timeOut = b ? 0 : parseInt(u.val())),
                    d.val().length &&
                        (toastr.options.extendedTimeOut = b
                            ? 0
                            : parseInt(d.val())),
                    h.val().length && (toastr.options.showEasing = h.val()),
                    m.val().length && (toastr.options.hideEasing = m.val()),
                    v.val().length && (toastr.options.showMethod = v.val()),
                    k.val().length && (toastr.options.hideMethod = k.val()),
                    b &&
                        ((r = (function (t) {
                            return (
                                (t = t || "Clear itself?"),
                ...
                (t = y),
                    void 0 !== y &&
                        (y.find("#okBtn").length &&
                            y.delegate("#okBtn", "click", function () {
                                alert(
                        ...
                        y.find("#surpriseBtn").length &&
                            y.delegate("#surpriseBtn", "click", function () {
                                alert(
                        ...
                        y.find(".clear").length &&
                            y.delegate(".clear", "click", function () {
                                toastr.clear(y, { force: !0 });
                            }));
            }),
