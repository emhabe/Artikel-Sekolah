...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('assets2/imgs/favicon.png')}}">
    <!-- UltraNews CSS  -->
    <link rel="stylesheet" href="{{asset('assets2/css/style.css')}}">
    <link rel="stylesheet" href="{{asset('assets2/css/widgets.css')}}">
    <link rel="stylesheet" href="{{asset('assets2/css/color.css')}}">
...
<body>
        ...
        <aside id="sidebar-wrapper" class="custom-scrollbar offcanvas-sidebar">
            ...
            <div class="sidebar-inner">
                        ...
                        <ul class="list-post">
                                ...
                                <div class="d-flex">
                                    <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                        <a class="color-white" href="single.html">
                                            <img src="assets2/imgs/thumbnail-1.jpg" alt="">
                                        </a>
                                    </div>
                            ...
                            <li class="mb-30">
                                <div class="d-flex">
                                    <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                        <a class="color-white" href="single.html">
                                            <img src="assets2/imgs/thumbnail-2.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="post-content media-body">
                            ...
                            <li class="mb-30">
                                <div class="d-flex">
                                    <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                        <a class="color-white" href="single.html">
                                            <img src="assets2/imgs/thumbnail-3.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="post-content media-body">
                            ...
                            <li class="mb-30">
                                <div class="d-flex">
                                    <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                        <a class="color-white" href="single.html">
                                            <img src="assets2/imgs/thumbnail-4.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="post-content media-body">
                                        <h6 class="post-title mb-10 text-limit-2-row"><a href="single.html">Last Minute Festive Packages From Superbreak</a></h6>
                            ...
                            <li class="mb-30">
                                <div class="d-flex">
                                    <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                        <a class="color-white" href="single.html">
                                            <img src="assets2/imgs/thumbnail-5.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="post-content media-body">
                                        <h6 class="post-title mb-10 text-limit-2-row"><a href="single.html">Last Minute Festive Packages From Superbreak</a></h6>
                ...
                <div class="sidebar-widget widget-ads mb-30">
                    <a href="assets2/imgs/news-1.jpg" class="play-video" data-animate="zoomIn" data-duration="1.5s" data-delay="0.1s">
                        <img src="assets2/imgs/ads-1.jpg" alt="">
                    </a>
                </div>
            </div>
        </aside>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="language d-inline-block font-small">
                                <div id="langMenuDropdow" class="dropdown-menu dropdown-menu-left" aria-labelledby="langMenu">
                                    ...
                                    <a class="dropdown-item" href="index.html#">РУССКИЙ</a>
                                </div>
                                <a class="dropdown-toggle" href="index.html#" role="button" id="langMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div id="datetime" class="d-inline-block">
                                <ul>
                                    <li><span class="font-small"><i class="wi wi-day-cloudy mr-5"></i>34ºc, Sunny. <a class="active" href="index.html#">London</a></span></li>
                                    <li><span class="font-small"><i class="ti-calendar mr-5"></i>Monday, April 6, 2020</span></li>
                                    <li><a class="active" href="index.html#"><span class="font-small"><i class="ti-book mr-5"></i>Read Today’s Paper</span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-6 text-right">
                            <ul class="header-social-network d-inline-block list-inline">
                                <li class="list-inline-item"><a class="social-icon facebook-icon text-xs-center" target="_blank" href="index.html#"><i class="ti-facebook"></i></a></li>
                                <li class="list-inline-item"><a class="social-icon twitter-icon text-xs-center" target="_blank" href="index.html#"><i class="ti-twitter-alt"></i></a></li>
                                <li class="list-inline-item"><a class="social-icon pinterest-icon text-xs-center" target="_blank" href="index.html#"><i class="ti-pinterest"></i></a></li>
                                <li class="list-inline-item"><a class="social-icon instagram-icon text-xs-center" target="_blank" href="index.html#"><i class="ti-instagram"></i></a></li>
                            </ul>
                            <div class="vline-space d-inline-block"></div>
                            <div class="user-account d-inline-block font-small">
                                <a class="dropdown-toggle" href="index.html#" role="button" id="userMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="ti-user"></i>
                                    <span>Account</span>
                                </a>
                                <div id="userMenuDropdow" class="dropdown-menu dropdown-menu-right" aria-labelledby="userMenu">
                                    <a class="dropdown-item" href="index.html#"><i class="ti-pencil-alt"></i>Edit Profile</a>
                                    <a class="dropdown-item" href="index.html#"><i class="ti-settings"></i>Account Settings</a>
                                    <a class="dropdown-item" href="index.html#"><i class="ti-stats-up"></i>Your Dashboard</a>
                                    <a class="dropdown-item" href="index.html#"><i class="ti-heart"></i>Your Favorites</a>
            ...
            <div class="header-logo background-white text-center pt-40 pb-40 d-none d-lg-block">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <a href="index.html">
                                <img class="logo-img d-inline" src="assets2/imgs/logo.png" alt="">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="logo-tablet d-md-inline d-lg-none d-none">
                                <a href="index.html">
                                    <img class="logo-img d-inline" src="assets2/imgs/logo-tablet.png" alt="">
                                </a>
                            </div>
                            <div class="logo-mobile d-inline d-md-none">
                                <a href="index.html">
                                    <img class="logo-img d-inline" src="assets2/imgs/logo-mobile.png" alt="">
                                </a>
                            </div>
                            <!-- Main-menu -->
                                        ...
                                        <li class="mega-menu-item">
                                            ...
                                            <div class="sub-mega-menu">
                                                <div class="nav flex-column nav-pills" role="tablist">
                                                    <a class="nav-link active" data-toggle="pill" href="index.html#news-0" role="tab">All</a>
                                                    <a class="nav-link" data-toggle="pill" href="index.html#news-1" role="tab">Entertaiment</a>
                                                    <a class="nav-link" data-toggle="pill" href="index.html#news-2" role="tab">Fashion</a>
                                                    <a class="nav-link" data-toggle="pill" href="index.html#news-3" role="tab">Life Style</a>
                                                    <a class="nav-link" data-toggle="pill" href="index.html#news-4" role="tab">Technology</a>
                                                    <a class="nav-link" data-toggle="pill" href="index.html#news-5" role="tab">Travel</a>
                                                </div>
                                                <div class="tab-content">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-3 post-module-1">
                                                                <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                                                    <a href="single.html">
                                                                        <img src="assets2/imgs/news-1.jpg" alt="">
                                                                    </a>
                                                            ...
                                                            <div class="col-3 post-module-1">
                                                                <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                                                    <a href="single.html">
                                                                        <img src="assets2/imgs/news-2.jpg" alt="">
                                                                    </a>
                                                                </div>
                                                                <div class="post-content media-body">
                                                            ...
                                                            <div class="col-3 post-module-1">
                                                                <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                                                    <a href="single.html">
                                                                        <img src="assets2/imgs/news-3.jpg" alt="">
                                                                    </a>
                                                                </div>
                                                                <div class="post-content media-body">
                                                            ...
                                                            <div class="col-3 post-module-1">
                                                                <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                                                    <a href="single.html">
                                                                        <img src="assets2/imgs/news-8.jpg" alt="">
                                                                    </a>
                                                                </div>
                                                                <div class="post-content media-body">
                                                    ...
                                                    <div class="tab-pane" id="news-1" role="tabpanel">
                                                        <div class="row">
                                                            <div class="col-3 post-module-1">
                                                                <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                                                    <a href="single.html">
                                                                        <img src="assets2/imgs/news-5.jpg" alt="">
                                                                    </a>
                                                                </div>
                                                                <div class="post-content media-body">
                                                                    <h6 class="post-title mb-10 text-limit-2-row">The litigants on the screen are not actors </h6>
                                                            ...
                                                            <div class="col-3 post-module-1">
                                                                <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                                                    <a href="single.html">
                                                                        <img src="assets2/imgs/news-6.jpg" alt="">
                                                                    </a>
                                                            ...
                                                            <div class="col-3 post-module-1">
                                                                <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                                                    <a href="single.html">
                                                                        <img src="assets2/imgs/news-7.jpg" alt="">
                                                                    </a>
                                                                </div>
                                                                <div class="post-content media-body">
                                                                    <h6 class="post-title mb-10 text-limit-2-row">We got a right to pick a little fight, Bonanza </h6>
                                                    ...
                                                    <div class="tab-pane" id="news-2" role="tabpanel">
                                                        <div class="row">
                                                            <div class="col-3 post-module-1">
                                                                <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                                                    <a href="single.html">
                                                                        <img src="assets2/imgs/news-9.jpg" alt="">
                                                                    </a>
                                                                    <span class="top-right-icon background2">
                                                                        <i class="mdi mdi-audiotrack"></i>
                                                                    </span>
                                                            ...
                                                            <div class="col-3 post-module-1">
                                                                <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                                                    <a href="single.html">
                                                                        <img src="assets2/imgs/news-10.jpg" alt="">
                                                                    </a>
                                                            ...
                                                            <div class="col-3 post-module-1">
                                                                <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                                                    <a href="single.html">
                                                                        <img src="assets2/imgs/news-11.jpg" alt="">
                                                                    </a>
                                                                </div>
                                                                <div class="post-content media-body">
                                                                    <h6 class="post-title mb-10 text-limit-2-row">We got a right to pick a little fight, Bonanza </h6>
                                                            ...
                                                            <div class="col-3 post-module-1">
                                                                <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                                                    <a href="single.html">
                                                                        <img src="assets2/imgs/news-12.jpg" alt="">
                                                                    </a>
                                                                </div>
                                                                <div class="post-content media-body">
                                                                    <h6 class="post-title mb-10 text-limit-2-row">My entrance exam was on a book of matches </h6>
                                                    ...
                                                    <div class="tab-pane" id="news-3" role="tabpanel">
                                                        <div class="row">
                                                            <div class="col-3 post-module-1">
                                                                <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                                                    <a href="single.html">
                                                                        <img src="assets2/imgs/news-13.jpg" alt="">
                                                                    </a>
                                                                </div>
                                                                <div class="post-content media-body">
                                                                    <h6 class="post-title mb-10 text-limit-2-row">The litigants on the screen are not actors </h6>
                                                            ...
                                                            <div class="col-3 post-module-1">
                                                                <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                                                    <a href="single.html">
                                                                        <img src="assets2/imgs/news-14.jpg" alt="">
                                                                    </a>
                                                                </div>
                                                                <div class="post-content media-body">
                                                                    <h6 class="post-title mb-10 text-limit-2-row">Not a bit of hesitation, you better think twice</h6>
                                                            ...
                                                            <div class="col-3 post-module-1">
                                                                <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                                                    <a href="single.html">
                                                                        <img src="assets2/imgs/news-15.jpg" alt="">
                                                                    </a>
                                                                </div>
                                                                <div class="post-content media-body">
                                                                    <h6 class="post-title mb-10 text-limit-2-row">We got a right to pick a little fight, Bonanza </h6>
                                                            ...
                                                            <div class="col-3 post-module-1">
                                                                <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                                                    <a href="single.html">
                                                                        <img src="assets2/imgs/news-16.jpg" alt="">
                                                                    </a>
                                                                    <span class="top-right-icon background2">
                                                                        <i class="mdi mdi-audiotrack"></i>
                                                                    </span>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-3 post-module-1 text-left">
                                                                <div class="post-thumb position-relative">
                                                                    <div class="thumb-overlay img-hover-slide border-radius-5 position-relative" style="background-image: url(assets2/imgs/news-11.jpg)">
                                                                        ...
                                                                        <div class="post-content-overlay">
                                                                            ...
                                                                            <div class="entry-meta meta-1 font-small color-grey mt-10 pr-5 pl-5">
                                                                                ...
                                                                                <a class="float-right" href="index.html#" tabindex="0"><i class="ti-heart"></i></a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-3 post-module-1 text-left">
                                                                <div class="post-thumb position-relative">
                                                                    <div class="thumb-overlay img-hover-slide border-radius-5 position-relative" style="background-image: url(assets2/imgs/news-2.jpg)">
                                                                        <a class="img-link" href="single.html" tabindex="0"></a>
                                                                        <div class="post-content-overlay">
                                                                            <div class="entry-meta meta-0 font-small mb-10">
                                                            ...
                                                            <div class="col-3 post-module-1 text-left">
                                                                <div class="post-thumb position-relative">
                                                                    <div class="thumb-overlay img-hover-slide border-radius-5 position-relative" style="background-image: url(assets2/imgs/news-6.jpg)">
                                                                        <a class="img-link" href="single.html" tabindex="0"></a>
                                                                        <div class="post-content-overlay">
                                                                            <div class="entry-meta meta-0 font-small mb-10">
                                                            ...
                                                            <div class="col-3 post-module-1 text-left">
                                                                <div class="post-thumb position-relative">
                                                                    <div class="thumb-overlay img-hover-slide border-radius-5 position-relative" style="background-image: url(assets2/imgs/news-15.jpg)">
                                                                        <a class="img-link" href="single.html" tabindex="0"></a>
                                                                        <div class="post-content-overlay">
                                                                            <div class="entry-meta meta-0 font-small mb-10">
                                                    ...
                                                    <div class="tab-pane" id="news-5" role="tabpanel">
                                                        <div class="row">
                                                            <div class="col-3 post-module-1 text-left">
                                                                <div class="post-thumb position-relative">
                                                                    <div class="thumb-overlay img-hover-slide border-radius-5 position-relative" style="background-image: url(assets2/imgs/thumbnail-1.jpg)">
                                                                        <a class="img-link" href="single.html" tabindex="0"></a>
                                                                        <span class="top-right-icon background3">
                                                                            <i class="mdi mdi-videocam"></i>
                                                                        </span>
                                                            ...
                                                            <div class="col-3 post-module-1 text-left">
                                                                <div class="post-thumb position-relative">
                                                                    <div class="thumb-overlay img-hover-slide border-radius-5 position-relative" style="background-image: url(assets2/imgs/thumbnail-2.jpg)">
                                                                        <a class="img-link" href="single.html" tabindex="0"></a>
                                                                        <div class="post-content-overlay">
                                                                            <div class="entry-meta meta-0 font-small mb-10">
                                                                                <a href="category.html" tabindex="0"><span class="post-cat background7 color-white">Travel</span></a>
                                                            ...
                                                            <div class="col-3 post-module-1 text-left">
                                                                <div class="post-thumb position-relative">
                                                                    <div class="thumb-overlay img-hover-slide border-radius-5 position-relative" style="background-image: url(assets2/imgs/thumbnail-3.jpg)">
                                                                        <a class="img-link" href="single.html" tabindex="0"></a>
                                                                        <div class="post-content-overlay">
                                                                            <div class="entry-meta meta-0 font-small mb-10">
                                                                                <a href="category.html" tabindex="0"><span class="post-cat background4 color-white">World</span></a>
                                                            ...
                                                            <div class="col-3 post-module-1 text-left">
                                                                <div class="post-thumb position-relative">
                                                                    <div class="thumb-overlay img-hover-slide border-radius-5 position-relative" style="background-image: url(assets2/imgs/thumbnail-7.jpg)">
                                                                        <a class="img-link" href="single.html" tabindex="0"></a>
                                                                        <div class="post-content-overlay">
                                                                            <div class="entry-meta meta-0 font-small mb-10">
                                                                                <a href="category.html" tabindex="0"><span class="post-cat background3 color-white">Fashion</span></a>
                            ...
                            <div class="nav-shopping-cart">
                                <div class="dropdown cart_dropdown">
                                    <a class="cart-icon nav-link cart_trigger" href="index.html#" data-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <div class="cart_box dropdown-menu dropdown-menu-right keep-open">
                                        <ul class="cart_list">
                                            <li>
                                                <img class="float-left" src="assets2/imgs/shop/thumbnail/product-1-1.jpg" alt="cart_thumb1">
                                                <a href="index.html#">Dead Men Womens2</a>
                                                <a href="index.html#" class="item_remove font-small"><i class="ti-close"></i></a>
                                                <span class="cart_quantity"> 1 x <span class="cart_amount"> <span class="price_symbole">$</span></span>75.00</span>
                                            </li>
                                            <li>
                                                <img class="float-left" src="assets2/imgs/shop/thumbnail/product-9-1.jpg" alt="cart_thumb1">
                                                <a href="index.html#">Zoo Puzzle Kids</a>
                                                <a href="index.html#" class="item_remove font-small"><i class="ti-close"></i></a>
            ...
            <div class="main-search-form transition-02s">
                <div class="container">
                    <div class="pt-10 pb-50 main-search-form-cover">
                        <div class="row mb-20">
                            <div class="col-12">
                                <form action="index.html#" method="get" class="search-form position-relative">
                                    ...
                                    <div class="search-switch">
                                        <ul class="list-inline">
                                            <li class="list-inline-item"><a href="index.html#" class="active">Articles</a></li>
                                            <li class="list-inline-item"><a href="index.html#">Authors</a></li>
                                        </ul>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12 font-small suggested-area">
                                ...
                                <ul class="list-inline d-inline-block">
                                    ...
                                    <li class="list-inline-item"><a href="index.html#">Health</a></li>
                                    <li class="list-inline-item"><a href="index.html#">WFH</a></li>
                                    <li class="list-inline-item"><a href="index.html#">UltraNet</a></li>
                                    <li class="list-inline-item"><a href="index.html#">Hospital</a></li>
                                    <li class="list-inline-item"><a href="index.html#">Policies</a></li>
                                    <li class="list-inline-item"><a href="index.html#">Energy</a></li>
                                    <li class="list-inline-item"><a href="index.html#">Business</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-lg-6 col-md-12 order-lg-1 order-2 align-center-vertical">
                                                <div class="slider-caption">
                                                    <div class="entry-meta meta-0 mb-25">
                                                        <a href="category.html"><span class="post-in background1 color-white font-small">World</span></a>
                                                    </div>
                                                    <h2 class="post-title"><a href="single.html">Why Teamwork Really Makes The Dream Work</a></h2>
                                                    ...
                                                    <p class="excerpt font-medium mt-25 mb-25">We live in a world where disruption and dynamism reign supreme and businesses must be ready to adapt to the many unpredictable changes that come with this...</p>
                                                    <div class="entry-meta meta-2">
                                                        <a class="float-left mr-10 author-img" href="author.html"><img src="assets2/imgs/author.png" alt=""></a>
                                                        <a href="author.html"><span class="author-name">Robert Fisk</span></a>
                                                        <br>
                                            ...
                                            <div class="slider-img col-lg-6 order-lg-2 order-1 col-md-12">
                                                <div class="img-hover-scale">
                                                    ...
                                                    <a href="single.html">
                                                        <img src="assets2/imgs/slide-1.jpg" alt="post-slider">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="slider-single">
                                        <div class="row no-gutters">
                                            <div class="col-lg-6 col-md-12 order-lg-1 order-2  align-center-vertical">
                                                <div class="slider-caption">
                                                    <div class="entry-meta meta-0 mb-25">
                                                        <a href="category.html"><span class="post-in background2 color-white font-small">Lifestyle</span></a>
                                                    </div>
                                                    <h2 class="post-title"><a href="single.html">This Year Enjoy the Color of Festival with Amazing Holi Gifts Ideas</a></h2>
                                                    <div class="entry-meta meta-1 font-small color-grey mt-20 mb-20">
                                                        <span class="post-on"><i class="ti-marker-alt"></i>25 April 2020</span>
                                                        <span class="time-reading"><i class="ti-timer"></i>10 mins read</span>
                                                        <span class="hit-count"><i class="ti-bolt"></i> 159k Views</span>
                                                    </div>
                                                    <p class="excerpt font-medium mt-25 mb-25">At the Emmys, broadcast scripted shows created by people of color gained ground relative to those pitched by White show creators, while broadcast scripted shows...</p>
                                                    <div class="entry-meta meta-2">
                                                        <a class="float-left mr-10 author-img" href="author.html"><img src="assets2/imgs/author-2.png" alt=""></a>
                                                        <a href="author.html"><span class="author-name">Kate Adie</span></a>
                                                        <br>
                                                        <span class="author-add color-grey">London, United Kingdom</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="slider-img col-lg-6 order-lg-2 order-1 col-md-12">
                                                <div class="img-hover-scale">
                                                    <span class="top-right-icon background9"><i class="mdi mdi-grade"></i></span>
                                                    <a href="single.html">
                                                        <img src="assets2/imgs/slide-2.jpg" alt="post-slider">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="post-carausel-1-items row">
                                    <div class="slider-single col">
                                        ...
                                        <div class="img-hover-scale border-radius-5 hover-box-shadow">
                                            ...
                                            <a href="single.html"><img class="border-radius-5" src="assets2/imgs/thumbnail-9.jpg" alt="post-slider"></a>
                                        </div>
                                        <div class="entry-meta meta-1 font-small color-grey mt-10 pr-5 pl-5">
                                            <span class="post-on">02 Jan</span>
                                            <span class="hit-count has-dot">23k Views</span>
                                            <a class="float-right" href="index.html#"><i class="ti-heart"></i></a>
                                        </div>
                                    </div>
                                    <!--end slider single-->
                                    <div class="slider-single col">
                                        ...
                                        <div class="img-hover-scale border-radius-5 hover-box-shadow">
                                            <a href="single.html"><img class="border-radius-5" src="assets2/imgs/thumbnail-3.jpg" alt="post-slider"></a>
                                        </div>
                                        <div class="entry-meta meta-1 font-small color-grey mt-10 pr-5 pl-5">
                                    ...
                                    <div class="slider-single col">
                                        ...
                                        <div class="img-hover-scale border-radius-5 hover-box-shadow">
                                            ...
                                            <a href="single.html">
                                                <img class="border-radius-5" src="assets2/imgs/thumbnail-4.jpg" alt="post-slider">
                                            </a>
                                        </div>
                                        <div class="entry-meta meta-1 font-small color-grey mt-10 pr-5 pl-5">
                                    ...
                                    <div class="slider-single col">
                                        ...
                                        <div class="img-hover-scale border-radius-5 hover-box-shadow">
                                            <a href="single.html"><img class="border-radius-5" src="assets2/imgs/thumbnail-5.jpg" alt="post-slider"></a>
                                        </div>
                                        <div class="entry-meta meta-1 font-small color-grey mt-10 pr-5 pl-5">
                                    ...
                                    <div class="slider-single col">
                                        ...
                                        <div class="img-hover-scale border-radius-5 hover-box-shadow">
                                            ...
                                            <a href="single.html"><img class="border-radius-5" src="assets2/imgs/thumbnail-6.jpg" alt="post-slider"></a>
                                        </div>
                                        <div class="entry-meta meta-1 font-small color-grey mt-10 pr-5 pl-5">
                                    ...
                                    <div class="slider-single col">
                                        ...
                                        <div class="img-hover-scale border-radius-5 hover-box-shadow">
                                            <a href="single.html"><img class="border-radius-5" src="assets2/imgs/thumbnail-7.jpg" alt="post-slider"></a>
                                        </div>
                                        <div class="entry-meta meta-1 font-small color-grey mt-10 pr-5 pl-5">
                                    ...
                                    <div class="slider-single col">
                                        ...
                                        <div class="img-hover-scale border-radius-5 hover-box-shadow">
                                            <a href="single.html">
                                                <img class="border-radius-5" src="assets2/imgs/thumbnail-8.jpg" alt="post-slider"></a>
                                        </div>
                                        <div class="entry-meta meta-1 font-small color-grey mt-10 pr-5 pl-5">
                                            <span class="post-on">25 April</span>
                                            <span class="hit-count has-dot">26k Views</span>
                                ...
                                <div class="col-lg-9 col-md-9">
                                    ...
                                    <nav class="tab-nav style-1">
                                        <div class="nav nav-tabs" role="tablist">
                                            <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="index.html#nav-home" role="tab" aria-controls="nav-home" aria-selected="true"><i class="mr-5 ti-pulse"></i>All</a>
                                            <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="index.html#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Lifestyle</a>
                                            <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="index.html#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Travel</a>
                                            <a class="nav-item nav-link" id="nav-last-tab" data-toggle="tab" href="index.html#nav-last" role="tab" aria-controls="nav-contact" aria-selected="false">Fashion</a>
                                            <a class="nav-item nav-link" id="nav-Sports" data-toggle="tab" href="index.html#nav-nav-Sport" role="tab" aria-controls="nav-contact" aria-selected="false">Sports</a>
                                        </div>
                                    </nav>
                                    <!--End Tab Nav  -->
                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="post-block-style">
                                                            <div class="post-thumb position-relative thumb-overlay mb-15">
                                                                <div class="img-hover-slide border-radius-5 position-relative" style="background-image: url(assets2/imgs/news-9.jpg)">
                                            ...
                                            <div class="block-tab-item post-module-1">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="post-block-style">
                                                            <div class="post-thumb position-relative thumb-overlay mb-15">
                                                                <div class="img-hover-slide border-radius-5 position-relative" style="background-image: url(assets2/imgs/news-10.jpg)">
                                                                    <a class="img-link" href="single.html"></a>
                                                                    <div class="post-content-overlay entry-meta meta-0 font-small transition-ease-04"><a href="category.html"><span class="post-cat background1 color-white">Fashion</span></a></div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="block-tab-item post-module-1">
                                                ...
                                                <div class="row list-post">
                                                    ...
                                                    <div class="col-md-6 d-flex mb-30">
                                                        <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                                            <a href="single.html">
                                                                <img src="assets2/imgs/thumbnail-6.jpg" alt="">
                                                            </a>
                                                        </div>
                                                        <div class="post-content media-body">
                                                            <div class="entry-meta meta-0 mb-5">
                                                    ...
                                                    <div class="col-md-6 d-flex">
                                                        <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                                            <a href="single.html">
                                                                <img src="assets2/imgs/thumbnail-7.jpg" alt="">
                                                            </a>
                                                        </div>
                                                        <div class="post-content media-body">
                                                            <div class="entry-meta meta-0 mb-5">
                                                    ...
                                                    <div class="col-md-6 d-flex">
                                                        <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                                            <a href="single.html">
                                                                <img src="assets2/imgs/thumbnail-8.jpg" alt="">
                                                            </a>
                                                        </div>
                                                        <div class="post-content media-body">
                                                            <div class="entry-meta meta-0 mb-5">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="post-thumb position-relative mb-30">
                                                            <div class="thumb-overlay img-hover-slide border-radius-5 position-relative" style="background-image: url(assets2/imgs/news-1.jpg)">
                                                                <a class="img-link" href="single.html"></a>
                                                                <div class="post-content-overlay">
                                                                    <div class="entry-meta meta-0 font-small mb-10">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="post-thumb position-relative mb-30">
                                                            <div class="thumb-overlay img-hover-slide border-radius-5 position-relative" style="background-image: url(assets2/imgs/news-3.jpg)">
                                                                <a class="img-link" href="single.html"></a>
                                                                <div class="post-content-overlay">
                                                                    <div class="entry-meta meta-0 font-small mb-10">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="post-thumb position-relative mb-30">
                                                            <div class="thumb-overlay img-hover-slide border-radius-5 position-relative" style="background-image: url(assets2/imgs/news-4.jpg)">
                                                                <a class="img-link" href="single.html"></a>
                                                                <div class="post-content-overlay">
                                                                    <div class="entry-meta meta-0 font-small mb-10">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="post-thumb position-relative mb-30">
                                                            <div class="thumb-overlay img-hover-slide border-radius-5 position-relative" style="background-image: url(assets2/imgs/news-5.jpg)">
                                                                <a class="img-link" href="single.html"></a>
                                                                <div class="post-content-overlay">
                                                                    <div class="entry-meta meta-0 font-small mb-10">
                                            ...
                                            <div class="row">
                                                <div class="slider-single col-md-4 mb-30">
                                                    <div class="img-hover-scale border-radius-5">
                                                        <a href="single.html">
                                                            <img class="border-radius-5" src="assets2/imgs/thumbnail-6.jpg" alt="post-slider">
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="slider-single col-md-4 mb-30">
                                                    <div class="img-hover-scale border-radius-5">
                                                        <a href="single.html">
                                                            <img class="border-radius-5" src="assets2/imgs/thumbnail-10.jpg" alt="post-slider">
                                                        </a>
                                                    </div>
                                                    <h6 class="post-title pr-5 pl-5 mb-10 mt-15 text-limit-2-row">
                                                ...
                                                <div class="slider-single col-md-4 mb-30">
                                                    <div class="img-hover-scale border-radius-5">
                                                        <a href="single.html">
                                                            <img class="border-radius-5" src="assets2/imgs/thumbnail-11.jpg" alt="post-slider">
                                                        </a>
                                                    </div>
                                                    <h6 class="post-title pr-5 pl-5 mb-10 mt-15 text-limit-2-row">
                                                ...
                                                <div class="slider-single col-md-4 mb-30">
                                                    <div class="img-hover-scale border-radius-5">
                                                        <a href="single.html">
                                                            <img class="border-radius-5" src="assets2/imgs/thumbnail-12.jpg" alt="post-slider">
                                                        </a>
                                                    </div>
                                                    <h6 class="post-title pr-5 pl-5 mb-10 mt-15 text-limit-2-row">
                                                ...
                                                <div class="slider-single col-md-4 mb-30">
                                                    <div class="img-hover-scale border-radius-5">
                                                        <a href="single.html">
                                                            <img class="border-radius-5" src="assets2/imgs/thumbnail-8.jpg" alt="post-slider">
                                                        </a>
                                                    </div>
                                                    <h6 class="post-title pr-5 pl-5 mb-10 mt-15 text-limit-2-row">
                                                ...
                                                <div class="slider-single col-md-4 mb-30">
                                                    <div class="img-hover-scale border-radius-5">
                                                        <a href="single.html">
                                                            <img class="border-radius-5" src="assets2/imgs/thumbnail-7.jpg" alt="post-slider">
                                                        </a>
                                                    </div>
                                                    <h6 class="post-title pr-5 pl-5 mb-10 mt-15 text-limit-2-row">
                                    ...
                                    <div class="title_style_1">
                                        ...
                                        <div class="social-network">
                                            <div class="follow-us d-flex align-items-center">
                                                <a class="follow-us-facebook clearfix mr-5 mb-10" href="index.html#" target="_blank">
                                                ...
                                                <a class="follow-us-twitter clearfix ml-5 mb-10" href="index.html#" target="_blank">
                                                    <div class="social-icon">
                                            ...
                                            <div class="follow-us d-flex align-items-center">
                                                <a class="follow-us-instagram clearfix mr-5 mb-10" href="index.html#" target="_blank">
                                                    <div class="social-icon">
                                                ...
                                                <a class="follow-us-youtube clearfix ml-5 mb-10" href="index.html#" target="_blank">
                                                    <div class="social-icon">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-5 text-right">
                                            <h6 class="text-uppercase font-medium">
                                                ...
                                                <a class="color-white" href="index.html#">All Videos</a>
                                            </h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="block-tab-item post-module-1 post-module-4 mt-50">
                                    <div class="row">
                                        <div class="col-lg-5 col-md-6">
                                            <div class="post-thumb position-relative">
                                                <div class="thumb-overlay img-hover-slide border-radius-5 position-relative" style="background-image: url(assets2/imgs/news-7.jpg)">
                                            ...
                                            <div class="row">
                                                <div class="slider-single col-lg-4 col-md-6 mb-30">
                                                    <div class="img-hover-scale border-radius-5">
                                                        <span class="top-right-icon background10"><i class="mdi mdi-flash-on"></i></span>
                                                        <a href="single.html">
                                                            <img class="border-radius-5" src="assets2/imgs/thumbnail-3.jpg" alt="post-slider">
                                                        </a>
                                                ...
                                                <div class="slider-single col-lg-4 col-md-6 mb-30">
                                                    <div class="img-hover-scale border-radius-5">
                                                        <a href="single.html">
                                                            <img class="border-radius-5" src="assets2/imgs/thumbnail-2.jpg" alt="post-slider">
                                                        </a>
                                                        <div class="play_btn play_btn_small">
                                                            <a class="play-video" href="https://vimeo.com/333834999" data-animate="zoomIn" data-duration="1.5s" data-delay="0.1s">
                                                                <i class="ti-control-play"></i>
                                                ...
                                                <div class="slider-single col-lg-4 col-md-6 mb-30">
                                                    <div class="img-hover-scale border-radius-5">
                                                        <a href="single.html">
                                                            <img class="border-radius-5" src="assets2/imgs/thumbnail-1.jpg" alt="post-slider">
                                                        </a>
                                                        <div class="play_btn play_btn_small">
                                                            <a class="play-video" href="https://vimeo.com/333834999" data-animate="zoomIn" data-duration="1.5s" data-delay="0.1s">
                                                                <i class="ti-control-play"></i>
                                                ...
                                                <div class="slider-single col-lg-4 col-md-6">
                                                    <div class="img-hover-scale border-radius-5">
                                                        ...
                                                        <a href="single.html">
                                                            <img class="border-radius-5" src="assets2/imgs/thumbnail-9.jpg" alt="post-slider">
                                                        </a>
                                                        <div class="play_btn play_btn_small">
                                                            <a class="play-video" href="https://vimeo.com/333834999" data-animate="zoomIn" data-duration="1.5s" data-delay="0.1s">
                                                                <i class="ti-control-play"></i>
                        ...
                        <div class="col-lg-8 col-md-12">
                            ...
                            <div class="loop-list">
                                <article class="row mb-50">
                                    <div class="col-md-6">
                                        <div class="post-thumb position-relative thumb-overlay mr-20">
                                            <div class="img-hover-slide border-radius-5 position-relative" style="background-image: url(assets2/imgs/news-11.jpg)">
                                                <a class="img-link" href="single.html"></a>
                                                <span class="top-right-icon background8"><i class="mdi mdi-flash-on"></i></span>
                                            </div>
                                        </div>
                                ...
                                <article class="row mb-50">
                                    <div class="col-md-6">
                                        <div class="post-thumb position-relative thumb-overlay mr-20">
                                            <div class="img-hover-slide border-radius-5 position-relative" style="background-image: url(assets2/imgs/news-12.jpg)">
                                                <a class="img-link" href="single.html"></a>
                                ...
                                <article class="row mb-50">
                                    <div class="col-md-6">
                                        <div class="post-thumb position-relative thumb-overlay mr-20">
                                            <div class="img-hover-slide border-radius-5 position-relative" style="background-image: url(assets2/imgs/news-13.jpg)">
                                                <a class="img-link" href="single.html"></a>
                                            ...
                                            <div class="single-wrap d-flex justify-content-center">
                                                <nav aria-label="Page navigation example">
                                                    <ul class="pagination justify-content-start">
                                                        <li class="page-item"><a class="page-link" href="index.html#"><i class="flaticon-left"></i> </a></li>
                                                        <li class="page-item active"><a class="page-link" href="index.html#">01</a></li>
                                                        <li class="page-item"><a class="page-link" href="index.html#">02</a></li>
                                                        <li class="page-item"><a class="page-link" href="index.html#">03</a></li>
                                                        <li class="page-item"><a class="page-link" href="index.html#"><i class="flaticon-right"></i> </a></li>
                                                    </ul>
                                                </nav>
                                            </div>
                                        </div>
                            ...
                            <div class="widget-area">
                                ...
                                <div class="sidebar-widget widget-social-network mb-30">
                                    ...
                                    <div class="social-network">
                                        ...
                                        <div class="follow-us d-flex align-items-center">
                                            <a class="follow-us-instagram clearfix mr-5" href="index.html#" target="_blank">
                                                <div class="social-icon">
                                                    <i class="ti-instagram mr-5 v-align-space"></i>
                                                    <i class="ti-instagram mr-5 v-align-space nth-2"></i>
                                                </div>
                                            ...
                                            <a class="follow-us-youtube clearfix ml-5" href="index.html#" target="_blank">
                                                <div class="social-icon">
                                                    <i class="ti-youtube mr-5 v-align-space"></i>
                                                    <i class="ti-youtube mr-5 v-align-space nth-2"></i>
                                                </div>
                                    ...
                                    <div class="widget-taber-content background-white pt-30 pb-30 pl-30 pr-30 border-radius-5">
                                        <nav class="tab-nav float-none mb-20">
                                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                ...
                                                <a class="nav-item nav-link" id="nav-trending-tab" data-toggle="tab" href="index.html#nav-trending" role="tab" aria-controls="nav-trending" aria-selected="false">Trending</a>
                                                <a class="nav-item nav-link" id="nav-comment-tab" data-toggle="tab" href="index.html#nav-comment" role="tab" aria-controls="nav-comment" aria-selected="false">Comments</a>
                                            </div>
                                        </nav>
                                        <div class="tab-content">
                                            <!--Tab Popular-->
                                            ...
                                            <div class="tab-pane fade" id="nav-trending" role="tabpanel" aria-labelledby="nav-trending-tab">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 sm-grid-content mb-30">
                                                        <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                                            <a href="single.html">
                                                                <img src="assets2/imgs/news-4.jpg" alt="">
                                                            </a>
                                                        </div>
                                                        <div class="post-content media-body">
                                                    ...
                                                    <ul class="list-post">
                                                        ...
                                                        <li class="mb-30">
                                                            <div class="d-flex">
                                                                <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                                                    <a href="single.html">
                                                                        <img src="assets2/imgs/thumbnail-9.jpg" alt="">
                                                                    </a>
                                                                </div>
                                                                <div class="post-content media-body">
                                                                    <div class="entry-meta meta-0 mb-10">
                                ...
                                <div class="sidebar-widget widget-ads mb-30 text-center">
                                    <a href="https://vimeo.com/333834999" class="play-video" data-animate="zoomIn" data-duration="1.5s" data-delay="0.1s">
                                        <img class="d-inline-block" src="assets2/imgs/ads-2.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <ul class="list-post">
                                        <li class="mb-30">
                                            <div class="d-flex">
                                                <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                                    <a class="color-white" href="single.html">
                                                        <img src="assets2/imgs/thumbnail-13.jpg" alt="">
                                                    </a>
                                                </div>
                                                <div class="post-content media-body">
                                                    <h6 class="post-title mb-10 text-limit-2-row"><a class="color-white" href="single.html">Traveling Tends to Magnify All Human Emotions</a></h6>
                                        ...
                                        <li class="mb-30">
                                            <div class="d-flex">
                                                <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                                    <a class="color-white" href="single.html">
                                                        <img src="assets2/imgs/thumbnail-11.jpg" alt="">
                                                    </a>
                                                </div>
                                                <div class="post-content media-body">
                                                    <h6 class="post-title mb-10 text-limit-2-row"><a class="color-white" href="single.html">Last Minute Festive Packages From Superbreak</a></h6>
                            ...
                            <div class="sidebar-widget widget_categories mb-30">
                                ...
                                <div class="post-block-list post-module-1 post-module-5">
                                    <ul class="float-left mr-30 font-medium">
                                        <li class="cat-item cat-item-2"><a href="index.html#">Global Economy</a></li>
                                        <li class="cat-item cat-item-3"><a href="index.html#">Environment</a></li>
                                        <li class="cat-item cat-item-4"><a href="index.html#">Religion</a></li>
                                        <li class="cat-item cat-item-5"><a href="index.html#">Fashion</a></li>
                                        <li class="cat-item cat-item-6"><a href="index.html#">Terrorism</a></li>
                                        <li class="cat-item cat-item-7"><a href="index.html#">Conflicts</a></li>
                                        <li class="cat-item cat-item-2"><a href="index.html#">Scandals</a></li>
                                        <li class="cat-item cat-item-2"><a href="index.html#">Executive</a></li>
                                        <li class="cat-item cat-item-2"><a href="index.html#">Foreign policy</a></li>
                                    </ul>
                                    <ul class="float-left font-medium">
                                        <li class="cat-item cat-item-2"><a href="index.html#">Healthy Living</a></li>
                                        <li class="cat-item cat-item-3"><a href="index.html#">Medical Research</a></li>
                                        <li class="cat-item cat-item-4"><a href="index.html#">Children’s Health</a></li>
                                        <li class="cat-item cat-item-5"><a href="index.html#">Around the World</a></li>
                                        <li class="cat-item cat-item-6"><a href="index.html#">Ad Choices</a></li>
                                        <li class="cat-item cat-item-7"><a href="index.html#">Mental Health</a></li>
                                        <li class="cat-item cat-item-2"><a href="index.html#">Media Relations</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                                ...
                                <div class="newsletter">
                                    ...
                                    <div class="footer-form">
                                        <div id="mc_embed_signup">
                                            <form target="_blank" action="index.html#" method="get" class="subscribe_form relative mail_part">
                            ...
                            <div class="sidebar-widget widget_instagram">
                                ...
                                <div class="instagram-gellay">
                                    <ul class="insta-feed">
                                        <li>
                                            <a href="assets2/imgs/thumbnail-3.jpg" class="play-video" data-animate="zoomIn" data-duration="1.5s" data-delay="0.1s"><img class="border-radius-5" src="assets2/imgs/thumbnail-12.jpg" alt=""></a>
                                        </li>
                                        <li>
                                            <a href="assets2/imgs/thumbnail-4.jpg" class="play-video" data-animate="zoomIn" data-duration="1.5s" data-delay="0.1s"><img class="border-radius-5" src="assets2/imgs/thumbnail-9.jpg" alt=""></a>
                                        </li>
                                        <li>
                                            <a href="assets2/imgs/thumbnail-5.jpg" class="play-video" data-animate="zoomIn" data-duration="1.5s" data-delay="0.1s"><img class="border-radius-5" src="assets2/imgs/thumbnail-10.jpg" alt=""></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="row d-flex align-items-center justify-content-between">
                            <div class="col-lg-6">
                                <div class="footer-copy-right">
                                    <p class="font-medium">© 2020, UltraNews | All rights reserved | Design by <a href="../../../alithemes_default.html" target="_blank">AliThemes</a></p>
                                </div>
                            </div>
                            <div class="col-lg-6">
    ...
    <script src="{{asset('assets2/js/vendor/jquery.slicknav.js')}}"></script>
    ...
    <script src="{{asset('assets2/js/vendor/animated.headline.js')}}"></script>
    <script src="{{asset('assets2/js/vendor/jquery.magnific-popup.js')}}"></script>
    <script src="{{asset('assets2/js/vendor/jquery.ticker.js')}}"></script>
    <script src="{{asset('assets2/js/vendor/jquery.vticker-min.js')}}"></script>
    <script src="{{asset('assets2/js/vendor/jquery.scrollUp.min.js')}}"></script>
    <script src="{{asset('assets2/js/vendor/jquery.nice-select.min.js')}}"></script>
    <script src="{{asset('assets2/js/vendor/jquery.sticky.js')}}"></script>
    <script src="{{asset('assets2/js/vendor/perfect-scrollbar.js')}}"></script>
    ...
    <script src="{{asset('assets2/js/vendor/jquery.theia.sticky.js')}}"></script>
    <!-- UltraNews JS -->
